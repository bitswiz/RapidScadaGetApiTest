...
namespace RapidScadaWebApiTest
{
    /// <summary>
    ...
    internal class Program
    {
        ...
        {
            const string RootPath = "http://localhost:10008/";
            ...
            else if (JsonSerializer.Deserialize<SimpleResult>(loginResponseString, JsonOptions) is SimpleResult loginResult)
            {
